...
class VisitPhotoTest(TestCase):
    ...
    def test_contract_is_net_and_vat_is_derived(self):
        ...
        self.err("forbidden", billing.update_commercials, u["u_pm1"], np_.id, {"contractValueNet": 2_000_000})
        ...
        self.err("forbidden", billing.set_contract_status, u["u_pm1"], np_.id, {"status": "received"})
