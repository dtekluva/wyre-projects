...
MATRIX: dict[str, list[str]] = {
    ...
    "director": ["project.create", "project.read", "project.update", "gate.request", "gate.approve", "chronology.read",
                 ...
                 "recon.read", "dashboard.read", "catalogue.manage", "billing.manage", "contract.manage", "record.void", "stage.rollback"],
    ...
    "techlead": ["project.create", "project.read", "project.update", "gate.request", "gate.approve",
                 ...
                 "warranty.create", "warranty.check", "dashboard.read", "catalogue.manage", "contract.manage", "billing.manage", "record.void", "stage.rollback"],
    ...
    "finance": ["stockcount.approve", "warranty.check", "project.read", "project.update", "gate.request", "gate.approve", "chronology.read", "document.read", "document.create", "attachment.read", "attachment.create",
