...
COMMANDS: dict[str, Handler] = {
    ...
    "recordVatPayment": lambda a, d, f: S.vat_payment(billing.record_vat_payment(a, d.get("projectId"), _in(d))),
    "addVatPaymentReceipts": lambda a, d, f: S.vat_payment(billing.add_vat_payment_receipts(a, d.get("paymentId"), _in(d))),
