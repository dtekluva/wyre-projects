...
const LABEL: Record<EventType, string> = {
  ...
  issue: "Issue", commissioning: "Commissioning", hse: "HSE", warranty: "Warranty", stock_count: "Count", contract_updated: "Commercials", contract_received: "Contract received", invoice: "Invoice",
};
