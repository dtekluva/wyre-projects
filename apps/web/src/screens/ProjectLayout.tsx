    ...
    <>
      ...
      <div className="workspace">
        ...
        <aside className="ctx">
          ...
          <div className="card ctx__card"><div className="ctx__title">Stage</div><div className="sm"><b>{STAGES[p.stage].name}</b><div className="muted">{p.stagePlanned[p.stage] ? `Planned exit ${p.stagePlanned[p.stage]}` : "No planned exit date"} · <Link to={`/projects/${p.id}#schedule`} className="link">schedule</Link></div><div style={{ marginTop: 6 }}><RollbackControl p={p} /></div></div></div>
